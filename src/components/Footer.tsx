    ...
    <footer className="bg-muted text-muted-foreground py-8 px-4 mt-12 mb-16 md:mb-0">
      <div className="max-w-4xl mx-auto">
        <p className="text-xs md:text-sm leading-relaxed mb-4 text-center">
          Copyright 2025 Christian Survival Watch. This site is not part of the Facebook website or Facebook Inc. Additionally, This site is NOT endorsed by Facebook in any way. FACEBOOK is a trademark of FACEBOOK, Inc.
        </p>
